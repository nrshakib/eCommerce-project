    ...
    <div className="justify-center mt-5 flex">
      ...
      <div className="ml-5">
        ...
        <p className="w-96 mb-2">
          ...
          sunt fugiat aspernatur libero commodi dolorem reiciendis eum possimus
          ipsum.
        </p>
        <select className="w-32 h-8 text-center rounded mb-8" name="Select Size" id="">
        ...
        <br />
        <button className="w-32 border-2 p-2 rounded-lg bg-yellow-500">Add To Cart</button>
      </div>
    </div>
  );
};
